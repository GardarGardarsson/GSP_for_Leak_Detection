...
if __name__ == "__main__" :
    ...
    parser.add_argument('--weights',
                        ...
                        choices = ['unweighted' , 'hydraulic_loss' , 'log_hydraulic_loss',
                                   'pruned'     , 'pipe_length'    , 'inv_pipe_length'],
                        type    = str,
    ...
    '''
    3.   I M P O R T   D A T A S E T   C O N F I G
    '''
    ...
    '''
    4.   G E N E R A T E   N O M I N A L   D A T A   F O R   T R A I N I N G
    '''
    ...
    weights   = ['unweighted' , 'pipe_length']
    
    self_loop = [ True        ,  True ]

    
    for weight,self_loop in zip(weights,self_loop):
        print('+-----------------------------+')
        print('| Initiating training session ')
        print('| Edge weights:  {}'.format(weight))
        print('| Self loops:    {}'.format('yes' if self_loop else 'no'))
        print('+-----------------------------+')
        ...
        execution_no   = 1                                                                  # Initialise execution ID number
        execution_id   = args.wdn + '-' + args.gnn + '-' + weight + '-' + args.scaling + '-' + '{}'.format('self_loop-' if self_loop else '')# Initialise execution ID name
        logs           = [log for log in os.listdir(path_to_logs) if log.endswith('.csv')]  # Load all logs in directory to list
        ...
        '''
        5.   P R E P A R E   T R A I N I N G   D A T A    
        '''
        ...
        '''
        6.   C O N V E R T   E P A N E T   T O   G R A P H
        '''
        ...
        G , pos , head = get_nx_graph(wdn, weight_mode=weight, get_head=True)
        
        '''
        6.5   T E S T I N G   S E L F   L O O P S   O N   S E N S O R   N O D E S
        '''
        ...
        '''
        7.   S E T U P   F O R   T R A I N I N G 
        '''
        ...
        # If we've already trained a model with the same setup
        if execution_no > 1:
        ...
        estop    = EarlyStopping(min_delta=.00001, patience=args.epochs)       # By setting patience as # of epochs we make sure early stopping is never initiated
